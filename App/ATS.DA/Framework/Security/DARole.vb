...
Namespace Framework
   ''' <summary>
    ...
    ''' <remarks></remarks>
    Public Class DARole
        Inherits DataAccessBase(Of Role)
...
#Region " Overrides Methods "
        Public Overrides Function Delete(ByVal Id As Integer) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Users.SpRole_Delete")
                    Using cmd
        ...
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Try
                ...
                Using oCon
                    ...
                    Using cmd
                        ...
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@Tables", SqlDbType.NVarChar, -1).Value = "Users.Role"
            ...
            If MyBase.RowsEffected > 0 Then
                MyBase.GetPagesTotal("Users.Role", SqlWhere(DataEntity), PageSize)
            Else
                MyBase.PageTotal = 0
            End If
        ...
        Public Function GetUserRolesDataset(ByVal UserAccountId As Integer) As System.Data.DataSet
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Users.SpRole_GetAll")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
            ...
            Return MyBase.Dataset
        End Function
        Public Function LoadRoleByUserAccountId(ByVal UserAccountId As Integer) As System.Collections.Generic.List(Of Role)
        ...
        ByVal DataEntity As Role, _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Collections.Generic.List(Of Role)
            Dim List As New List(Of Role)
            ...
            Return List
        End Function
        Public Overrides Function Find(ByVal Id As Integer) As Role
            ...
            sb.AppendFormat("{0}{1}", "FROM Users.Role ", Environment.NewLine)
            ...
            Return oRole
        End Function
        Protected Overrides Function SqlSelect(ByVal Entity As Role) As String
            Dim sb As New System.Text.StringBuilder
            sb.AppendFormat("{0}{1}", "RoleId, ", Environment.NewLine)
            sb.AppendFormat("{0}{1}", "RoleName, ", Environment.NewLine)
            sb.AppendFormat("{0}{1}", "DepartmentId, ", Environment.NewLine)
            ...
            Return sb.ToString
        End Function
        Protected Overrides Function SqlWhere(ByVal Entity As Role) As String
            Dim sb As New System.Text.StringBuilder

            Select Case Entity.WhereFilter
                Case Role.FilterWhere.PrimaryKey
                    sb.AppendFormat("{0}{1}", "RoleId = " & Entity.RoleId.ToString, Environment.NewLine)
            End Select

            Return sb.ToString.Trim
        End Function
        Protected Overrides Function SqlOrderBy(ByVal Entity As Role) As String
            Dim sb As New System.Text.StringBuilder

            Select Case Entity.OrderByFilter
                Case Role.FilterOrderBy.None
                    sb.AppendFormat("{0}{1}", "RoleId ", Environment.NewLine)
...
#Region " Public Methods "
        ...
        ByVal AddedUserAccountId As Integer) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Users.SpRole_Insert")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
        ...
        ByVal VersionNo As Byte()) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Users.SpRole_Update")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
            ...
            Return boolSeccessed
        End Function
        Public Function GetCapabilitiesDataset(ByVal RoleId As Integer) As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    ...
                    Using cmd
                        ...
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@RoleId", SqlDbType.Int).Value = RoleId
                        End With
        ...
        As System.Collections.Generic.List(Of Role)
            Dim List As New List(Of Role)
            ...
            sb.AppendFormat("{0}{1}", "Role.DepartmentId, ", Environment.NewLine)
            ...
            sb.AppendFormat("{0}{1}", "FROM Users.Role ", Environment.NewLine)
            sb.AppendFormat("{0}{1}", "INNER JOIN Users.RoleUserAccount ", Environment.NewLine)
            sb.AppendFormat("{0}{1}", "ON Role.RoleId = RoleUserAccount.RoleId ", Environment.NewLine)
            sb.AppendFormat("{0}{1}", "WHERE UserAccountId = " & UserAccountId.ToString, Environment.NewLine)
            ...
            Return List
        End Function
        Public Function GetCapabilities(ByVal RoleId As Integer) As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
        ...
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Users.SpRole_GetByDeoartmentId")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
