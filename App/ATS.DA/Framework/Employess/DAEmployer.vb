                    ...
                    Using cmd
                        ...
                        If oReader.Read Then
                            With oEmployee
                                ...
                                .EmployerNameEN = FieldToString(oReader, 2)
...
#Region " Public Methods "
                ...
                Using oCon
                    ...
                    Using cmd
                        ...
                        With cmd.Parameters
                            ...
                            .Add("@EmployerNameEN", SqlDbType.NVarChar, 100).Value = StringToField(EmployerNameEN)
        ...
        Optional ByVal EmployerNameEN As String = "") As Boolean
            ...
            Return boolSeccessed
        End Function
        Public Function GetEmployersDataset( _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
        ...
        End Function
        Public Function GetEmployersListDataset(Optional ByVal Lang As String = "ar") As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
