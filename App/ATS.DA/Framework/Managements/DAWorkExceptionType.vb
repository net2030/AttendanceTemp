...
Namespace Framework
    Public Class DAWorkExceptionType
        Inherits DataAccessBase(Of WorkExceptionType)
...
#Region " Overrides Methods "
        Public Overrides Function Delete(ByVal Id As Integer) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpWorkExceptionType_Delete")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@WorkExceptionTypeId", SqlDbType.Int).Value = FieldToint32(Id)
        ...
        ByVal DataEntity As WorkExceptionType, _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Throw New NotImplementedException
        End Function
        Public Overloads Overrides Function Load() As System.Collections.Generic.List(Of WorkExceptionType)
            Throw New NotImplementedException
        End Function
        Public Overloads Overrides Function Load( _
        ByVal DataEntity As WorkExceptionType, _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Collections.Generic.List(Of WorkExceptionType)
            Throw New NotImplementedException
        End Function
        Public Overrides Function Find(ByVal Id As Integer) As WorkExceptionType
            Dim oEmployee As New WorkExceptionType

            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpWorkExceptionType_GetById")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@WorkExceptionTypeId", SqlDbType.Int).Value = Int32ToField(Id)
                        End With
                        ...
                        If oReader.Read Then
                            With oEmployee
                                .WorkExceptionTypeId = FieldToint32(oReader, 0)
                                .WorkExceptionTypeName = FieldToString(oReader, 1)
                                .WorkExceptionTypeNameEN = FieldToString(oReader, 2)
            ...
            Return oEmployee
        End Function
        Protected Overrides Function SqlSelect(ByVal Entity As WorkExceptionType) As String
            Dim sb As New System.Text.StringBuilder
            Return sb.ToString
        End Function
        Protected Overrides Function SqlWhere(ByVal Entity As WorkExceptionType) As String
            Dim sb As New System.Text.StringBuilder
            Return sb.ToString.Trim
        End Function
        Protected Overrides Function SqlOrderBy(ByVal Entity As WorkExceptionType) As String
            Dim sb As New System.Text.StringBuilder
            Return sb.ToString.Trim
        End Function
#End Region
...
#Region " Public Methods "
        ...
        Optional ByVal WorkExceptionTypeNameEN As String = "") As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpWorkExceptionType_Insert")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@WorkExceptionTypeName", SqlDbType.NVarChar, 100).Value = StringToField(WorkExceptionTypeName)
                            .Add("@WorkExceptionTypeNameEN", SqlDbType.NVarChar, 100).Value = StringToField(WorkExceptionTypeNameEN)
                            .Add("@UserAccountId", SqlDbType.Int).Value = Int32ToField(UserAccountId)

                            .Add(New SqlParameter("@WorkExceptionTypeId", SqlDbType.Int))
                            .Item("@WorkExceptionTypeId").Direction = ParameterDirection.Output
                            .Add(New SqlParameter("@RC", SqlDbType.Int))
                            .Item("@RC").Direction = ParameterDirection.Output
                            .Add(New SqlParameter("@RMsgId", SqlDbType.Int))
                            .Item("@RMsgId").Direction = ParameterDirection.Output
                        ...
                        If CInt(cmd.Parameters("@RC").Value) = 0 Then
                            MyBase.Identity = FieldToint32(cmd.Parameters("@WorkExceptionTypeId").Value)
                            MyBase.InfoMessage = FieldToString(cmd.Parameters("@RMessage").Value)
                            boolSeccessed = True
                        Else
                            MyBase.IfnoMessageId = FieldToint32(cmd.Parameters("@RMsgId").Value)
        ...
        ByVal WorkExceptionTypeId As Integer, _
        ByVal WorkExceptionTypeName As String,
        ...
        Optional ByVal WorkExceptionTypeNameEN As String = "") As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpWorkExceptionType_Update")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
            ...
            Return boolSeccessed
        End Function
        Public Function GetWorkExceptionTypesDataset( _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpWorkExceptionType_GetAll")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                        ...
                        MyBase.RowsEffected = Adapter.Fill(MyBase.Dataset, "WorkExceptionType")
        ...
        End Function
        Public Function GetWorkExceptionTypesListDataset(Optional ByVal Lang As String = "ar") As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpWorkExceptionType_GetList")
