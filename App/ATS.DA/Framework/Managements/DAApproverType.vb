...
Namespace Framework
    Public Class DAApproverType
        Inherits DataAccessBase(Of ApproverType)
...
#Region " Overrides Methods "
        Public Overrides Function Delete(ByVal Id As Integer) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpApproverType_Delete")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@ApproverTypeId", SqlDbType.Int).Value = FieldToint32(Id)
        ...
        ByVal DataEntity As ApproverType, _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Throw New NotImplementedException
        End Function
        Public Overloads Overrides Function Load() As System.Collections.Generic.List(Of ApproverType)
            Throw New NotImplementedException
        End Function
        Public Overloads Overrides Function Load( _
        ByVal DataEntity As ApproverType, _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Collections.Generic.List(Of ApproverType)
            Throw New NotImplementedException
        End Function
        Public Overrides Function Find(ByVal Id As Integer) As ApproverType
            Dim oEmployee As New ApproverType

            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpApproverType_GetById")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@ApproverTypeId", SqlDbType.Int).Value = Int32ToField(Id)
                        End With
                        ...
                        If oReader.Read Then
                            With oEmployee
                                .ApproverTypeId = FieldToint32(oReader, 0)
                                .ApproverTypeName = FieldToString(oReader, 1)
            ...
            Return oEmployee
        End Function
        Protected Overrides Function SqlSelect(ByVal Entity As ApproverType) As String
            Dim sb As New System.Text.StringBuilder
            Return sb.ToString
        End Function
        Protected Overrides Function SqlWhere(ByVal Entity As ApproverType) As String
            Dim sb As New System.Text.StringBuilder
            Return sb.ToString.Trim
        End Function
        Protected Overrides Function SqlOrderBy(ByVal Entity As ApproverType) As String
            Dim sb As New System.Text.StringBuilder
            Return sb.ToString.Trim
        End Function
#End Region
...
#Region " Public Methods "
        ...
        ByVal UserAccountId As Integer) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpApproverType_Insert")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                            .Add("@ApproverTypeName", SqlDbType.NVarChar, 100).Value = StringToField(ApproverTypeName)
                            .Add("@UserAccountId", SqlDbType.Int).Value = Int32ToField(UserAccountId)

                            .Add(New SqlParameter("@ApproverTypeId", SqlDbType.Int))
                            .Item("@ApproverTypeId").Direction = ParameterDirection.Output
                            .Add(New SqlParameter("@RC", SqlDbType.Int))
                            .Item("@RC").Direction = ParameterDirection.Output
                            .Add(New SqlParameter("@RMsgId", SqlDbType.Int))
                            .Item("@RMsgId").Direction = ParameterDirection.Output
                        ...
                        If CInt(cmd.Parameters("@RC").Value) = 0 Then
                            MyBase.Identity = FieldToint32(cmd.Parameters("@ApproverTypeId").Value)
                            MyBase.InfoMessage = FieldToString(cmd.Parameters("@RMessage").Value)
                            boolSeccessed = True
                        Else
                            MyBase.IfnoMessageId = FieldToint32(cmd.Parameters("@RMsgId").Value)
        ...
        ByVal ApproverTypeId As Integer, _
        ByVal ApproverTypeName As String,
        ...
        ByVal VersionNo As Byte()) As Boolean
            ...
            Try
                ...
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpApproverType_Update")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
            ...
            Return boolSeccessed
        End Function
        Public Function GetApproverTypesDataset( _
        Optional ByVal PageNo As Integer = 1, _
        Optional ByVal PageSize As Integer = 50) As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpApproverType_GetAll")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        With cmd.Parameters
                        ...
                        MyBase.RowsEffected = Adapter.Fill(MyBase.Dataset, "ApproverType")
        ...
        End Function
        Public Function GetApproverTypesListDataset() As System.Data.DataSet
            Try
                Dim oCon As SqlConnection = New SqlConnection(MyBase.ConnectionString)
                Using oCon
                    oCon.Open()
                    Dim cmd As New SqlCommand("Managements.SpApproverType_GetList")
                    Using cmd
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Connection = oCon
                        Dim Adapter As New SqlDataAdapter
