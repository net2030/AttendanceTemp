        ...
        Protected Overrides Function MapEntityToProperties(ByVal Entity As ATS.DA.Framework.ICommonAttributes) As BOEntityBase
            ...
            If Not IsNothing(Entity) Then
                ...
                With bWorkSchedule
                    ...
                    .WorkScheduleNameEN = eWorkSchedule.WorkScheduleNameEN
                    ...
                    .ShiftsCount = eWorkSchedule.ShiftsCount
                    .IsPeriodic = eWorkSchedule.IsPeriodic
                    .PeriodLength = eWorkSchedule.PeriodLength
                    .FirstPeriodStartDate = eWorkSchedule.FirstPeriodStartDate
...
#Region " Public Methods "
        ...
        Public Function GetList(Optional ByVal Lang As String = "ar") As DataSet
            Return New DAWorkSchedule().GetWorkSchedulesListDataset(Lang)
        End Function
                ...
                Select Case WorkSchedule.DBAction
                    Case BOEntityBase.DBActionEnum.Add
                        If Not Me.Add(
                                  ...
                                  WorkSchedule.ShiftsCount,
                                  WorkSchedule.IsPeriodic,
                                  WorkSchedule.PeriodLength,
                                  WorkSchedule.FirstPeriodStartDate,
                                  UserAccountId) Then
                            Return False
                        Else
...
#Region " Public Methods "
        ...
        End Function
        Public Function GetWorkScheduleDaysDataset(ByVal WorkScheduleId As Integer, Optional ByVal ShiftNo As Integer = 1) As System.Data.DataSet
            Dim ds As DataSet = Nothing
            Dim oWorkSchedule As New DAWorkScheduleDay
            ds = oWorkSchedule.GetWorkScheduleDaysDataset(WorkScheduleId, ShiftNo)
            MyBase.PageTotal = oWorkSchedule.PageTotal
            Return ds
        End Function
#End Region
...
#Region " Properties Mapping "
        ...
        Private Sub MapEntityToCustomProperties(ByVal entity As ICommonAttributes)
            ...
            With eWorkSchedule
                ...
                strWorkScheduleNameEN = .WorkScheduleNameEN
                ...
                intShiftsCount = .ShiftsCount
                bolIsPeriodic = .IsPeriodic
                intPeriodLength = .PeriodLength
                datFirstPeriodStartDate = .FirstPeriodStartDate
