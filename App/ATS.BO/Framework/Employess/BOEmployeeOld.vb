...
#Region " Overrides "
        ...
        Protected Overrides Function MapEntityToProperties(ByVal Entity As ATS.DA.Framework.ICommonAttributes) As BOEntityBase
            Dim bDepartment As New BOEEmployee
            ...
            If Not IsNothing(Entity) Then
                ...
                With bDepartment
                    ...
                    .IsGatepassApproval = eEmployee.IsGatepassApproval
        ...
        ByVal Entity As BOEntityBase) As ATS.DA.Framework.DataEntityBase
            ...
            If Not IsNothing(Entity) Then
                ...
                With eEmployee
                    ...
                    .IsGatepassApproval = bEmployee.IsGatepassApproval
                End With
            End If
...
#Region " Public Methods "
        ...
        Public Function GetUnregisteredEmployees(ByVal DepartmentId As Integer, ByVal Op As Integer) As System.Data.DataSet
            Return New DAEmployee().GetUnregisteredEmployees(DepartmentId, Op)
        End Function
...
#Region " Mapping "
        ...
        Private Sub MapEntityToCustomProperties(ByVal entity As ICommonAttributes)
            ...
            With eEmployee
                ...
                bolIsGatepassApproval = .IsGatepassApproval
