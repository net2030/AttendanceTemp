<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployeesWorkSchedule.ascx.vb" Inherits="AccountAdmin_Controls_ctlEmployeesWorkSchedule"  %>
...
<%--<asp:UpdatePanel ID="UpdatePanel2" runat="server" >
    ...
    <div>
        ...
        <table  class="xAdminOption" style="font-size:large;width:630PX">
                <tr>
                    <th class="caption" style="text-align:center;font-size:large;">
                        <asp:Literal ID="Literal9" runat="server" Text="Ì „  ÿ»Ìﬁ «·ÃœÊ· ⁄·Ï «·„ÊŸ›Ì‰ «· «·ÌÌ‰"/>
                    </th>
                </tr>
                <tr>
                            ...
                            <tr>
                                ...
                                <td style="width:330px">
                                    <telerik:RadListBox ID="SelectedListBox" 
                                                        ...
                                                        DataTextField="EmployeeName" 
                                                        DataValueField="EmployeeId" Font-Names="Arial" Font-Size="Large"  AllowTransfer="True" ><localization alltoleft="≈÷«›… «·Ã„Ì⁄" alltoright="Õ–› «·Ã„Ì⁄" toleft="≈÷«›…" toright="Õ–›" /><ButtonSettings TransferButtons="All"></ButtonSettings>
                                    </telerik:RadListBox>
