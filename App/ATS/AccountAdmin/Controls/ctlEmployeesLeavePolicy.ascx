<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployeesLeavePolicy.ascx.vb" Inherits="AccountAdmin_Controls_ctlEmployeesLeavePolicy"  %>
                    ...
                    <tr>
                        <td>
                            ...
                            <telerik:radlistbox runat="server"
                                id="AvailableListBox"  AppendDataBoundItems="true"   OnClientTransferring="OnClientTransferring" 
...
<%--<asp:UpdatePanel ID="UpdatePanel2" runat="server" >
    ...
    <div>
        ...
        <table  class="xAdminOption" style="font-size:large;width:900PX">
                <tr>
                ...
                <tr>
                    <td>
                        <table class="xFormView" border="0" style="font-size:large;width:100%" >
                            ...
                            <tr>
                                ...
                                <td style="width:50%">
                                    <telerik:RadListBox ID="SelectedListBox" 
                                                        ...
                                                        width="100%"  Height="300px" 
                                                        DataTextField="EmployeeName" 
                                                        DataValueField="EmployeeId" Font-Names="Arial" Font-Size="Large" DataSourceID="dsEmployeesByManager" AllowTransfer="True" ><localization alltoleft="≈÷«›… «·Ã„Ì⁄" alltoright="Õ–› «·Ã„Ì⁄" toleft="≈÷«›…" toright="Õ–›" /><ButtonSettings TransferButtons="All"></ButtonSettings>
                                    </telerik:RadListBox>
        ...
        var listbox = $find("<%= AvailableListBox.ClientID%>");
          ...
          createMatchingList(listbox, textbox.get_textBoxValue());
            ...
            function OnClientTransferring(sender, args) {
                var id = '<%= SelectedListBox.ClientID%>'
          if (args.get_sourceListBox().get_id() == id) {
              args.set_cancel(!confirm('”Ì „ Õ–› «·√—’œ… «·„Õ”Ê»…! Â· √‰  „ √ﬂœ ø'));
          }
      }

        </script>
<asp:ObjectDataSource id="dsEmployeesByManager" runat="server" TypeName="ATS.BO.Framework.BOTimeOffPolicy" SelectMethod="GetTimeOffPolicyEmployees" OldValuesParameterFormatString="original_{0}"><SelectParameters>
