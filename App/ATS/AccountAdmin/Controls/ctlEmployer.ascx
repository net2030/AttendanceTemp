<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployer.ascx.vb" Inherits="AccountAdmin_Controls_ctlEmployer" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployerId" 
            DataSourceID="dsAccountEmployerObject" SkinID="xgridviewSkinEmployee" AllowSorting="True" Width="98%" Caption="ÃäæÇÚ ÇáÅÓÊÆÐÇäÇÊ" CssClass="tableView" meta:resourcekey="GridView1Resource1">
            <Columns>
                <asp:BoundField DataField="EmployerId" HeaderText="ÇáÑÞã" InsertVisible="False"
                    ReadOnly="True" SortExpression="EmployerId" meta:resourcekey="BoundFieldResource1">
                ...
                <asp:BoundField DataField="EmployerName" HeaderText="" SortExpression="EmployerName" meta:resourcekey="BoundFieldResource3">
            <HeaderStyle HorizontalAlign="Center" />
            <ItemStyle HorizontalAlign="Center" />
        </asp:BoundField>

                <asp:BoundField DataField="EmployerNameEN" HeaderText="" SortExpression="EmployerNameEN" meta:resourcekey="BoundFieldResource2">
            <HeaderStyle HorizontalAlign="Center" />
            <ItemStyle HorizontalAlign="Center" />
        </asp:BoundField>
        ...
        <asp:ObjectDataSource ID="dsAccountEmployerObject" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetEmployersDataset" TypeName="ATS.BO.Framework.BOEmployer">
            <SelectParameters>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="EmployerId"
            ...
            <EditItemTemplate>
                <table width="100%" class="xview">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAccountEmployerId" runat="server" ReadOnly="True" Text='<%# Bind("EmployerId") %>' meta:resourcekey="txtAccountEmployerIdResource1"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td style="width: 75%; height: 26px;">
                            <asp:TextBox
                                ID="AccountEmployerTextBox" runat="server"
                                Text='<%# Bind("EmployerName") %>' MaxLength="50" Width="176px" meta:resourcekey="AccountEmployerTextBoxResource1"></asp:TextBox><asp:RequiredFieldValidator
                                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountEmployerTextBox"
                      ...
                      <tr>
                        ...
                        <td style="width: 75%; height: 26px;">
                            <asp:TextBox
                                ID="AccountEmployerENTextBox" runat="server"
                                Text='<%# Bind("EmployerNameEN")%>' MaxLength="50" Width="176px" meta:resourcekey="AccountEmployerTextBoxResource1"></asp:TextBox><asp:RequiredFieldValidator
                                    ID="RequiredFieldValidator2" runat="server" ControlToValidate="AccountEmployerENTextBox"
                                    Display="Dynamic" ErrorMessage="*" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator></td>
                    </tr>
                ...
                <table width="100%" class="xview">
                    ...
                    <tr>
                        ...
                        <td style="width: 75%; height: 26px;">
                            <asp:TextBox
                                ID="AccountEmployerTextBox" runat="server"
                                Text='<%# Bind("AccountEmployer") %>' MaxLength="50" Width="176px" meta:resourcekey="AccountEmployerTextBoxResource2"></asp:TextBox><asp:RequiredFieldValidator
                                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountEmployerTextBox"
