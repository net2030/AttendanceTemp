...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="WorkExceptionTypeId"
            DataSourceID="dsAccountWorkExceptionTypeObject" SkinID="xgridviewSkinEmployee" AllowSorting="True" Width="98%" Caption="ÃäæÇÚ ÇáÅÓÊËÇÁÇÊ" CssClass="tableView" meta:resourcekey="GridView1Resource1">
            <Columns>

                <asp:BoundField DataField="WorkExceptionTypeId" HeaderText="ÇáÑÞã" InsertVisible="False"
