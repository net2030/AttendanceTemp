<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployeesHolidayException.ascx.vb" Inherits="AccountAdmin_Controls_ctlEmployeesHolidayException"  %>
                ...
                <table class="xAdminOption" style="width: 500px">
                    <tr>
                        <th class="caption" style="text-align: center;">
                            <asp:Literal ID="Literal9" runat="server" Text="ÇáãæÙÝíä ÇáÐíä Êã ÅÓÊËäÇÄåã ãä ÇáÚØáÉ" meta:resourcekey="Literal9Resource1"  />
                        </th>
                    </tr>
                    <tr>
...
<asp:ObjectDataSource id="dsExceptedEmployees" runat="server" TypeName="ATS.BO.Framework.BOHolidayExceptionEmployee" SelectMethod="GetHolidayExceptionEmployeesDataset" OldValuesParameterFormatString="original_{0}"><SelectParameters>
        <asp:SessionParameter Name="HolidayId" SessionField="HolidayId" Type="Int32" />
