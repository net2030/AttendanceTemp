...
Partial Class AccountAdmin_Controls_ctrlEmployeeDevices
    Inherits System.Web.UI.UserControl
    Dim moMachineEmployee As BOMachineEmployee = New BOMachineEmployee
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.DataBound
        dt = moMachineEmployee.GetMachinesByEmployee(CInt(Session("EmployeeId1"))).Tables(0)
