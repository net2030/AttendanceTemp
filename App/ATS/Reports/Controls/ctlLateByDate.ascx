<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlLateByDate.ascx.vb" Inherits="Employee_Controls_ctlAbsentsBydate" %>
...
<div style="border:solid;width:700px;">
    ...
    <tr>
        <th colspan="6" class="caption" style="text-align:center;">
            <asp:Literal ID="Literal9" runat="server" Text="ÊÞÑíÑ ÛíÇÈ ÞÓã ãÍÏÏ" meta:resourcekey="Literal9Resource1"/>
        </th>
    </tr>
    <tr>
        <th colspan="6" class="FormViewSubHeader" style="text-align:center;">
            <asp:Literal ID="Literal10" runat="server" Text="íÚÑÖ åÐÇ ÇáÊÞÑíÑ ÛíÇÈ ãæÙÝí ÞÓã ãÚíä ÎáÇá ÊÇÑíÎ ãÚíä" meta:resourcekey="Literal10Resource1" />
        </th>
    </tr>
    <tr>
        <td >
...
<br />
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="575px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="700px">
