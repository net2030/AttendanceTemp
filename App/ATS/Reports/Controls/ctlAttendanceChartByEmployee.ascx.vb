...
Partial Class Employee_Controls_ctlAttendanceChartByEmployee
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     If Not Me.IsPostBack Then
            ...
            ReportViewer1.LocalReport.ReportPath = "Reports\RDLC\" + Lang + "\Charts\rptEmployeeAttendanceSummuryByDate.rdlc"
        End If
    End Sub
    ...
    Protected Sub btnView()
        Try
            ...
            'Dim LogoURL As String = Request.Url.AbsoluteUri.Replace("Reports/AttendanceChartByEmployee.aspx", "") + "/Uploads/" & DBUtilities.GetSessionAccountId & "/Logo/CompanyLogo.gif"
            ...
            If CInt(Session("AccountRoleId")) = 2 Then
                Me.ReportViewer1.LocalReport.DataSources.Add(New ReportDataSource("AttendanceChart", moAttendanceLog.GetEmployeeAttendanceSummuryChartDataForReport(CInt(Session("AccountEmployeeId")), Startdate.SelectedDate, Enddate.SelectedDate).Tables(0)))
            Else
                Me.ReportViewer1.LocalReport.DataSources.Add(New ReportDataSource("AttendanceChart", moAttendanceLog.GetEmployeeAttendanceSummuryChartDataForReport(ddlEmployees.SelectedValue, Startdate.SelectedDate, Enddate.SelectedDate).Tables(0)))
            End If
