...
Partial Class Employee_Controls_ctlAbsentsBydate
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            ReportViewer1.LocalReport.ReportPath = "Reports\RDLC\" + Lang + "\rptGetLatesCommersByDate.rdlc"
    ...
    Protected Sub btnView()
        Try
            ...
            ' Dim LogoURL As String = Request.Url.AbsoluteUri.Replace("Reports/LateComersByDate.aspx", "") + "/Uploads/" & DBUtilities.GetSessionAccountId & "/Logo/CompanyLogo.gif"
            ...
            Me.ReportViewer1.LocalReport.DataSources.Add(New ReportDataSource("EmployeeAttendanceDataset", moAttendanceLog.GetLateComersByDateDataset(CInt(ctlDepartmentTree1.SelectedValue), Startdate.SelectedDate, Enddate.SelectedDate, 0).Tables(0)))
