...
Partial Class Employee_Controls_ctlAttendanceSummuryChartByDateAndDepartment
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            ReportViewer1.LocalReport.ReportPath = "Reports\RDLC\" + Lang + "\Charts\rptDepartmentAttendanceSummuryByDate.rdlc"
        End If
    End Sub
    ...
    Protected Sub btnView()
        Try
            ...
            'Dim LogoURL As String = Request.Url.AbsoluteUri.Replace("Reports/AttendanceChartSummuryByDepartment.aspx", "") + "/Uploads/" & DBUtilities.GetSessionAccountId & "/Logo/CompanyLogo.gif"
            ...
            Me.ReportViewer1.LocalReport.DataSources.Add(New ReportDataSource("AttendanceChart", moAttendanceLog.GetAttendanceSummuryChartDataForReport(CInt(ctlDepartmentTree1.SelectedValue), Startdate.SelectedDate, Enddate.SelectedDate).Tables(0)))
