...
Partial Class Employee_Controls_ctlAbsentsBydate
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            ReportViewer1.LocalReport.ReportPath = "Reports\RDLC\" + Lang + "\rptGetAbsentsByDate.rdlc"
        End If
    End Sub
    ...
    Protected Sub btnView()
        Try
            ...
            'Dim LogoURL As String = Request.Url.AbsoluteUri.Replace("Reports/AbsentsByDate.aspx", "") + "/Uploads/" & DBUtilities.GetSessionAccountId & "/Logo/CompanyLogo.gif"
            ...
            Me.ReportViewer1.LocalReport.DataSources.Add(New ReportDataSource("EmployeeAttendanceDataset", moAttendanceLog.GetAbsentsByDateDataset(CInt(ctlDepartmentTree1.SelectedValue), Startdate.SelectedDate, Enddate.SelectedDate, 1).Tables(0)))
