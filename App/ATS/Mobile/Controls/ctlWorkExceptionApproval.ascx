<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlWorkExceptionApproval.ascx.vb" Inherits="Mobile_Controls_ctlWorkExceptionApproval" %>
...
<script type="text/javascript">
    ...
    //$(document).on('click touchstart', '.ui-checkbox > label > span.label-editable', function (e) {
    ...
    //$(document).on('click touchstart', '#id', function (e) {
    //    alert("");
    //    //editCheckbox($(this));
    //    //e.stopPropagation();
    //    //e.preventDefault();
...
<div data-role="header" data-theme="a" >
       <h1 style="text-align:left;margin-left:15px;" >List of Pending WorkExceptiones </h1>
</div>
...
<div data-role="content1" data-theme="d" style="width:100%" >  
  ...
  <asp:Repeater ID="R" runat="server" DataSourceID="dsWorkExceptionesApproval"  >
      <HeaderTemplate>
           <ul data-filter="false" data-inset="True" data-role="listview" data-split-icon="delete"  >
      </HeaderTemplate>
          <ItemTemplate>
                        
      <asp:HiddenField ID="HiddenField1" runat="server" value='<%# Eval("WorkExceptionId") %>' />
                 <li >
                  <div style="float:left;margin-left:0px">
                   ...
                   <img alt="Details" id='imgdiv<%# Eval("WorkExceptionId") %>' src="../Images/plus.png" />
                              ...
                              <asp:LinkButton ID="lnkDayView" runat="server"
                                             style="font-size:9pt " 
                                             Text='<%# Eval("EmployeeName") & " - " & Eval("Period") & " - " & "يوم"%>' Enabled="false" >
                             </asp:LinkButton>   
                    ...
                    <div id='div<%# Eval("WorkExceptionId")%>' style="display: none;">
                       <table style="width:100%">
                           <tr>
                               ...
                               <td >
                                   <%# DataBinder.Eval(Container.DataItem, "WorkExceptionTypeName") %>
                               </td>
                           ...
                           <tr>
                               ...
                               <td colspan="2">
                                   <%# DataBinder.Eval(Container.DataItem, "WorkExceptionBegDate")%>
                               </td>
                           ...
                           <tr>
                               ...
                               <td>
                                  ...
                                  <td colspan="2">
                                   <%# DataBinder.Eval(Container.DataItem, "WorkExceptionEndDate")%>
                               </td>
                           </tr>
                           <tr>
...
<asp:ObjectDataSource ID="dsWorkExceptionesApproval"  runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetWorkExceptionByEmployeeManagerForApprovalDataset" TypeName="ATS.BO.Framework.BOWorkException">
    <SelectParameters>
