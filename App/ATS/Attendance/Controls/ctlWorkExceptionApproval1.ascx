...
<x:GridView ID="EmployeeManagerGridView" runat="server" AutoGenerateColumns="False"
    ...
    Caption="ÞÇÆãÉ ÈÅÓÊÆÐÇä ÇáãæÙÝíä Ýí ÇäÊÙÇÑ ãæÇÝÞÊß ßÜ ãÏíÑ ãÈÇÔÑ(Direct Manager)"
...
<ItemStyle Width="20px"></ItemStyle>
        ...
        <asp:BoundField DataField="WorkExceptionid" HeaderText="ÑÞã ÇáÍÇÓÈ" meta:resourcekey="BoundFieldResource7" />

        <asp:BoundField DataField="FullName" HeaderText="ÅÓã ÇáãæÙÝ" meta:resourcekey="BoundFieldResource8" />

        <asp:BoundField DataField="WorkExceptionTypeName" HeaderText="äæÚ ÇáÅÓÊËäÇÁ" meta:resourcekey="BoundFieldResource9" />

        <asp:BoundField DataField="WorkExceptionBegDate" HeaderText="íÈÏÃ ãä" meta:resourcekey="BoundFieldResource10" />

        <asp:BoundField DataField="WorkExceptionEndDate" HeaderText="íäÊåí Ýí" meta:resourcekey="BoundFieldResource11" />

        <asp:BoundField DataField="Notes" HeaderText="æÕÝ ÇáãåãÉ" meta:resourcekey="BoundFieldResource12" />

        <asp:TemplateField HeaderText="ÅÚÊãÇÏ " meta:resourcekey="TemplateFieldResource2">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="ÑÝÖ" meta:resourcekey="TemplateFieldResource3">
            <ItemTemplate>
...
<x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="WorkExceptionid" HeaderText="ÑÞã ÇáÍÇÓÈ" meta:resourcekey="BoundFieldResource13" />

        <asp:BoundField DataField="FullName" HeaderText="ÅÓã ÇáãæÙÝ" meta:resourcekey="BoundFieldResource14" />

        <asp:BoundField DataField="WorkExceptionTypeName" HeaderText="äæÚ ÇáÅÓÊËäÇÁ" meta:resourcekey="BoundFieldResource15" />

        <asp:BoundField DataField="WorkExceptionBegDate" HeaderText="íÈÏÃ ãä" meta:resourcekey="BoundFieldResource16" />

        <asp:BoundField DataField="WorkExceptionEndDate" HeaderText="íäÊåí Ýí" meta:resourcekey="BoundFieldResource17" />

        <asp:BoundField DataField="Notes" HeaderText="æÕÝ ÇáØáÈ" meta:resourcekey="BoundFieldResource18" />
...
<table style="width: 100%">
    <tr>
        <td>&nbsp<asp:Button ID="btnAddWorkException" runat="server" OnClick="btnAddWorkException_Click"
            Text="ÊÍÏíË ÍÇáÉ ÇáãæÇÝÞÇÊ" Width="163px" UseSubmitBehavior="False" meta:resourcekey="btnAddWorkExceptionResource1" />
