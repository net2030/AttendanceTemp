<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlVacationsAltEmployeeApproval.ascx.vb" Inherits="Attendance_Controls_ctlVacationsAltEmployeeApproval" %>
...
<asp:ObjectDataSource ID="dsVacation" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetVacationByAltEmployeeForApprovalDataset" TypeName="ATS.BO.FrameWork.BOVacation">
    <SelectParameters>
        <asp:SessionParameter Name="AltEmployeeId" SessionField="AccountEmployeeId" Type="Int32" />
    </SelectParameters>
