...
<ItemStyle Width="20px"></ItemStyle>
        ...
        <asp:BoundField DataField="Gatepassid" HeaderText="ÑÞã ÇáÍÇÓÈ" meta:resourcekey="BoundFieldResource7"  />

        <asp:BoundField DataField="FullName" HeaderText="ÅÓã ÇáãæÙÝ" meta:resourcekey="BoundFieldResource8"   />

        <asp:BoundField DataField="GatepassTypeName" HeaderText="äæÚ ÇáÅÓÊÆÐÇä" meta:resourcekey="BoundFieldResource9" />

        <asp:BoundField DataField="GatepassBegTime" HeaderText="íÈÏÃ ãä" meta:resourcekey="BoundFieldResource10" />

        <asp:BoundField DataField="GatepassEndTime" HeaderText="íäÊåí Ýí" meta:resourcekey="BoundFieldResource11" />

        <%--<asp:BoundField DataField="AprovalStatus" HeaderText="ÍÇáÉ ÇáØáÈ" />--%>
        <asp:BoundField DataField="Notes" HeaderText="æÕÝ ÇáØáÈ" meta:resourcekey="BoundFieldResource12" />
...
<x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Gatepassid" HeaderText="ÑÞã ÇáÍÇÓÈ" meta:resourcekey="BoundFieldResource13"  />

        <asp:BoundField DataField="FullName" HeaderText="ÅÓã ÇáãæÙÝ" meta:resourcekey="BoundFieldResource14"   />

        <asp:BoundField DataField="GatepassTypeName" HeaderText="äæÚ ÇáÅÓÊÆÐÇä" meta:resourcekey="BoundFieldResource15" />

        <asp:BoundField DataField="GatepassBegTime" HeaderText="íÈÏÃ ãä" meta:resourcekey="BoundFieldResource16" />

        <asp:BoundField DataField="GatepassEndTime" HeaderText="íäÊåí Ýí" meta:resourcekey="BoundFieldResource17" />
...
<table style="width: 100%">
    <tr>
        ...
        Text="ÊÍÏíË ÍÇáÉ ÇáãæÇÝÞÇÊ" Width="163px" UseSubmitBehavior="False" meta:resourcekey="btnAddGatePassResource1" />
