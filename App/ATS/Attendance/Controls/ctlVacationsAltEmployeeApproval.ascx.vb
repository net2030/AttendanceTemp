...
Partial Class Attendance_Controls_ctlVacationsAltEmployeeApproval
    ...
    Protected Sub btnAddGatePass_Click()
        ...
        For Each row1 As GridViewRow In GridView2.Rows
            ...
            If DirectCast(row1.FindControl("rdSpecificEmployee"), CheckBox).Checked = True Then
                If Not moVacation.UpdateVacationAltEmployeeApprovalStatus(VacationId, True, False, UserId, Notes) Then
                    GoTo end_of_for
                End If
            End If
            If DirectCast(row1.FindControl("rdSpecificEmployeeRejected"), CheckBox).Checked = True Then
                If Not moVacation.UpdateVacationAltEmployeeApprovalStatus(VacationId, False, True, UserId, Notes) Then
                    GoTo end_of_for
                End If
            End If
        Next
