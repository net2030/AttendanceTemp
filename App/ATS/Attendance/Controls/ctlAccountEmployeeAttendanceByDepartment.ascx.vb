...
Partial Class ctlAccountEmployeeAttendanceByDepartment
    ...
    Protected Sub GrdDepartmentAttendance0_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GrdDepartmentAttendance0.RowCommand
        Try
