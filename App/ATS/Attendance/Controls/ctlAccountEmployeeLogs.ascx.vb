...
Partial Class Controls_ctlEmployeeLogs
...
#Region "Data Binding"
    ...
    Private Function GetData() As DataSet
        ...
        Try
            ...
            Using oCon
                oCon.Open()
                Dim cmd As New SqlCommand("Logs.SpGetLogsByEmployee")
                Using cmd
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Connection = oCon
                    cmd.Parameters.Add("@EmployeeId", SqlDbType.Int).Value = Session("AccountEmployeeId")
...
#End Region
    ...
    Private Sub ExportGridToExcel()
        ...
        Response.Charset = ""
        Dim FileName As String = "Attendance_" & Session("AccountEmployeeFullName") & "_" & DateTime.Now & ".xls"
